...
public class available extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 120, 610, 210));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 350, 110, 50));
...
new F1().setVisible(true);// TODO add your handling code here:
   ...
   // SQLite connection string
        ...
        */
        String sql = "select Blood_group, sum(Units_left) from donor natural join donor_rem group by Blood_group;;";
        ...
        try{
            ...
            while (rs.next()) {
                Object[] row = { rs.getString("Blood_Group"), rs.getInt("sum(Units_left)") };
                model.addRow(row);
            }
        } catch (SQLException e) {
            System.out.println(e.getMessage());
